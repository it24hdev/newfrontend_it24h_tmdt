...
$(document).ready(function() {
    ...
    rangeSlider1.noUiSlider.on('update', function(values, handle) {
      document.getElementById('slider-range-value3').value = values[0];
      document.getElementById('slider-range-value4').value = values[1];
    //   document.getElementsByName('min-value').value = value.from(
    //     values[3]);
    //   document.getElementsByName('max-value').value = moneyFormat.from(
    //     values[4]);
    });
    ...
    $('.btn-filter-price').click(function(){
        var min_value = $('#slider-range-value1').val().replace(/\./g, '');
        var max_value = $('#slider-range-value2').val().replace(/\./g, '');
        document.getElementById('min-value').value = min_value;
        document.getElementById('max-value').value = max_value;
    });
