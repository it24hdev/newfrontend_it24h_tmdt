<script id="template_product_desktop" type="text/x-custom-template">
            ...
            <div class="lower_half">
                ...
                <a class="link_detail">
                    ...
                    <div class="price-review clearfix">
                        ...
                        <div class="review">
                            ...
                            <div class="sold"><i class="fas fa-badge-check"></i><span></span></div>
                        </div>
                    </div>
                </a>
                </div>
                <div class="detail-bottom">
                    ...
                    <div class="action">
                        ...
                        <a href="javascript:;" class="add-cart" title="Thêm vào giỏ hàng"><i class="far fa-shopping-cart"></i></a>
                    </div>
                </div>
            </div>
        </div>
