                                    ...
                                    <div class="owl-carousel owl-theme owl-loaded owl-drag" id="slider-show">
                                        @foreach ($sliders as $item)
                                            <a href="{{$item->link_target}}">
                                                ...
                                                @else
                                                    <img class="owl-lazy"
                                                         data-src="{{asset('upload/images/slider/'.$item->image)}}"
                                                         alt=""
                        ...
                        <div class="form-group wp-supper-deal p-3 mb-4">
                            ...
                            <form enctype="multipart/form-data" class="register_form">
                                <div class="form-group">
                                    ...
                                    <span class="icon-wrapper">
                                        ...
                                        <input class="form-control register_service" type="text" name="customer_name"
                                               placeholder="Họ và tên" required>
                                        <span
                                            class="required_name text-danger d-none"><i>Bạn chưa nhập họ và tên.</i></span>
                                </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="icon-wrapper">
                                        ...
                                        <span class="position-relative">
                                        <input class="form-control register_service" type="tel"
                                               name="customer_numberphone" placeholder="Số điện thoại" maxlength="12"
                                               required>
                                        <span
                                            class="required_phone text-danger d-none"><i>Bạn chưa nhập số điện thoại.</i></span>
                                    </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="icon-wrapper">
                                        ...
                                        <span class="position-relative">
                                        <input class="form-control register_service" type="email" name="customer_email"
                                               placeholder="Email">
                                    </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-wrapper">
                                    <span class="position-relative">
                                    <textarea class="form-control " name="customer_request" rows="3"
                                              placeholder="Nhập yêu cầu.." required></textarea>
                                    <span
                                        class="required_request text-danger d-none"><i>Bạn chưa nhập yêu cầu.</i></span>
                                    </span>
                                    </div>
                                </div>
                                <input id="registerservice" type="button"
                                       class="btn-submit btn btn-primary px-2 form-control mt-4" value="Đăng ký">
                            </form>
                            <div class="respone_register d-none">
                                <div class="register_error d-none">
                                    ...
                                    <input id="re_register" type="button" class="form-control btn btn-primary"
                                           value="Đăng ký lại">
                                </div>
                                <div class="register_success d-none">
                                    <p>Cảm ơn bạn đã đăng ký dịch vụ IT24h</p>
                                    <input id="newrequest" type="button" class="form-control btn btn-primary"
                                           value="Thêm yêu cầu">
                                </div>
                            </div>
                        ...
                        <div class="product-content mb-4" id="category-{{$cat_parent->id}}">
                            <div class="block-title flex-wrap">
                                <div class="d-flex w-100 overflow-hidden justify-content-between">
                                    ...
                                    <div class="linktocat"><a
                                            href="{{route('product_cat', ['slug' =>  $cat_parent->slug])}}"
                                            class="show-all"><span>Xem tất cả</span><i
                                                class="far fa-angle-right"></i></a></div>
                                </div>
                                <div class="d-flex align-items-center overflow-hidden w-100">
                                    <ul class="owl-carousel owl-theme owl-loaded owl-drag px-0 my-0"
                                        id="list-cat-child-{{$cat_parent->id}}"></ul>
                                </div>
                            </div>
