...
@csrf
            ...
            <div class="content">
                ...
                <h2 class="intro-y text-lg font-medium mt-10">
                    <a href="{{ route('categorypost.index')}}">{{ $title}}</a>
                </h2>
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        @can('createpost',App\Models\Category::class)
                        <a class="btn btn-primary shadow-md mr-2" href="{{ route('categorypost.create')}}" >Thêm danh mục</a>
                        @endcan
                        <div class="dropdown">
                        ...
                        <div class="hidden md:block mx-auto text-gray-600"></div>
                         <div class="hidden md:block mx-auto text-gray-600"></div>
                                 <form  action="{{ route('categorypost.index')}}" method="get" class="flex flex-col sm:flex-row sm:items-end xl:items-start">
