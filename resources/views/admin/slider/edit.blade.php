                ...
                <div class="intro-y box p-5">
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="col-span-12 xl:col-span-4">
                            ...
                            <div class="mt-3">
                                <input type="color" class="w-16 h-16 rounded-xl" name="colortop" value="{{$colortop}}">
                                <label>Màu nền trên</label>
                            </div>
                            <div class="mt-3">
                                <input type="color" class="w-16 h-16 rounded-xl" name="colorbottom" value="{{$colorbottom}}">
